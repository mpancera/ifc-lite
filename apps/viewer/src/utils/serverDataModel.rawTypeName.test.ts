...
const OUTSIDE_ENUM = [
  { id: 100, raw: 'IFCFASTENER', display: 'IfcFastener' },
  { id: 101, raw: 'IFCTENDONANCHOR', display: 'IfcTendonAnchor' },
  { id: 102, raw: 'IFCELECTRICDISTRIBUTIONPOINT', display: 'IfcElectricDistributionPoint' },
];
