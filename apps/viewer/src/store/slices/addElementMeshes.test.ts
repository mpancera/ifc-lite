 ...
 *  Fork: `sensor` and `library` carry a position too but take their own
 *  device builder, so they are excluded here rather than listed below. */
type BoxBackedType = Exclude<Extract<
  ElementMeshPayload,
