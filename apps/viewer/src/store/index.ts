...
const createViewerStore = () => create<ViewerState>()((...args) => ({
  ...
  openWorkspacePanel: (panel) => {
    ...
    set({
      ...
      exportsPanelVisible: panel === 'exports',
  ...
  toggleBottomPanel: (panel) => {
    ...
    const flagActive = panel === 'script' ? s.scriptPanelVisible
      : panel === 'gantt' ? s.ganttPanelVisible
        : panel === 'heights' ? s.heightsPanelVisible
          : panel === 'graph' ? s.graphPanelVisible
            : s.listPanelVisible;
    ...
    if (flagActive && !detached) {
      ...
      set({ scriptPanelVisible: false, ganttPanelVisible: false, listPanelVisible: false,
        heightsPanelVisible: false, graphPanelVisible: false });
    } else {
      set({
        scriptPanelVisible: panel === 'script',
        ganttPanelVisible: panel === 'gantt',
