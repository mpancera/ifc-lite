...
For everything from unit suites to latency simulation, curl smoke tests, audit-log inspection, and the determinism harness, see the dedicated guide: [Testing @ifc-lite/collab end-to-end](../contributing/collaboration-testing.md).
